...
const ForgotPassword = () => {
  ...
  return (
   ...
   <section className=' w-full container mx-auto px-2'>
    <div className='bg-red my-4 w-full max-w-lg mx-auto rounded p-7'>
       ...
       <form  className='grid gap-2 py-4 ' onSubmit={handleSubmit}>
        ...
        <div className='grid gap-1'>
            ...
            <Link to={"/forgot-password"} className='block ml-auto hover:text-primary-200'></Link>
        </div>
